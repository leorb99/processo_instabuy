...
class Welcome {
    ...
    factory Welcome.fromJson(Map<String, dynamic> json) => Welcome(
        ...
        variationItems: List<String>.from(json["variation_items"].map((x) => x)),
        relatedItems: List<String>.from(json["related_items"].map((x) => x)),
        slug: json["slug"],
        keywords: json["keywords"],
        unitType: json["unit_type"],
        incrementValue: json["increment_value"]?.toDouble(),
...
class Price {
    ...
    factory Price.fromJson(Map<String, dynamic> json) => Price(
        ...
        promoEndAt: DateTime.parse(json["promo_end_at"]),
    ...
    Map<String, dynamic> toJson() => {
        ...
        "promo_end_at": promoEndAt.toIso8601String(),
